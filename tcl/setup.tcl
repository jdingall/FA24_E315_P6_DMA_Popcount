...
create_fileset -simset axi4stream_synth 
add_files -fileset axi4stream_synth [glob ${TESTDIR}/axi4stream_synth/*.sv]
set_property top axi4stream_synth_tb [get_filesets axi4stream_synth]
