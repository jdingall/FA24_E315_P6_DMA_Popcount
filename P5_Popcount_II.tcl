...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "${origin_dir}/src/vsrc/axi4lite_interface.sv" \
   "${origin_dir}/src/vsrc/popcount.sv" \
...
set files [list \
 [file normalize "${origin_dir}/src/vsrc/axi4lite_interface.sv"] \
 [file normalize "${origin_dir}/src/vsrc/popcount.sv"] \
 [file normalize "${origin_dir}/src/vsrc/axi_popcount.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/vsrc/axi4lite_interface.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/vsrc/popcount.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "bd_fpga_wrapper" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/vtests/axi4lite_behav/axi4lite_behav_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/src/vtests/axi4lite_behav/axi4lite_behav_tb.sv"
set file [file normalize $file]
...
set_property -name "top" -value "axi4lite_behav_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/vtests/axi4lite_synth/axi4lite_synth_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_2' fileset file properties for remote files
set file "$origin_dir/src/vtests/axi4lite_synth/axi4lite_synth_tb.sv"
set file [file normalize $file]
...
# Proc to create BD bd_fpga
proc cr_bd_bd_fpga { parentCell } {
...
cr_bd_bd_fpga ""
set_property REGISTERED_WITH_MANAGER "1" [get_files bd_fpga.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files bd_fpga.bd ] 
...
# Proc to create BD bd_axi4lite_behav
proc cr_bd_bd_axi4lite_behav { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# axi_popcount
  ...
  # CHANGE DESIGN NAME HERE
  set design_name bd_axi4lite_behav
